 ...
 *
 * 用法:
 *   node plugins/fsflow/scripts/commands/archive-story.js <storyId> archive [--dry-run] [--round <N>] [--force]
 *     归档: root 全部文件（含 e2e-state.json / trace.jsonl / repos.json）移入 archive/round-{N}/
 *   node plugins/fsflow/scripts/commands/archive-story.js <storyId> restore [--round <N>] [--force] [--keep-archive]
 *     复档: archive/round-{N}/ 全部文件恢复到 root
 *   node plugins/fsflow/scripts/commands/archive-story.js <storyId> list
 *     列出所有归档轮次
 *   node plugins/fsflow/scripts/commands/archive-story.js <storyId> status
 *     查看当前归档状态
