 ...
 * 用法:
 *   独立执行:
 *     node plugins/fsflow/scripts/audit/metrics-aggregator.js                 # 聚合当前项目 + 合并到全局
 *     node plugins/fsflow/scripts/audit/metrics-aggregator.js --json          # JSON 输出（不写入全局）
 *     node plugins/fsflow/scripts/audit/metrics-aggregator.js --global-stats  # 查看全局统计
 *
 * 输出:
 ...
 *   - 人工诊断: `/fsflow:evolve` 的 Step 1 度量；或想定位本项目流程瓶颈
